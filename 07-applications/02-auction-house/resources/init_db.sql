...
(
    32
) DEFAULT 'active', -- active, ended, cancelled
...
(
    ...
    bidder_id INTEGER NOT NULL REFERENCES users
(
    id
),
    amount DECIMAL
...
VALUES ('alice', 'alice@example.com', 50000.00),
       ('bob', 'bob@example.com', 30000.00),
       ('charlie', 'charlie@example.com', 25000.00),
       ('david', 'david@example.com', 40000.00) ON CONFLICT DO NOTHING;
...
SELECT v.title,
       ...
       u.id AS seller_id,
       v.end_time
FROM (VALUES ('Vintage Rolex Submariner 1965',
             ...
             ('1959 Gibson Les Paul Standard',
              ...
              'music', 120000.00::numeric, 120000.00::numeric, 'alice', NOW() + INTERVAL '12 hours')) AS v(title,
                                                                                                           description,
                                                                                                           category,
                                                                                                           start_price,
                                                                                                           current_price,
