/**
 * @file examples/06-modules/redis/01-connect.cpp
 * @tier 06-modules
 * @teaches The redis seam: a client as an ordinary object, connected with co_await, and the string
 *          commands with the Reply<T> you check before you read.
 * @demonstrates qb::redis::tcp::client, qb::io::async::init, qb::io::async::run_until,
 ...
 * @expect "Basic Redis operations completed successfully!"
