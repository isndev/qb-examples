/**
 * @file examples/06-modules/http/01-hello-server.cpp
 * @tier 06-modules
 * @teaches The actor seam, stated once for the whole module: qb::http::Server<> inherited alongside
 *          qb::Actor, two routes, and the compile() that turns them into a radix tree.
 * @demonstrates qb::Actor, qb::http::Server<>, router(), get, compile, listen,
 *               qb::http::Status::OK, qb::http::AsyncTaskResult::COMPLETE, qb::io::async::task<bool>,
 *               qb::Main, addActor<T>
 * @prerequisites 01-actors/01-hello-actor
 * @expect "Server listening on http://localhost:8080"
 * @expect "   GET  /hello  - JSON greeting"
