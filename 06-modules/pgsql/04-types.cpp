/**
 * @file examples/06-modules/pgsql/04-types.cpp
 * @tier 06-modules
 * @teaches The type map, end to end: every common PostgreSQL OID written from and read back into its
 *          C++ counterpart, civil time and numeric included.
 * @demonstrates qb::pg::tcp::database, qb::pg::params, qb::pg::oid::int2, qb::pg::oid::int4,
 *               qb::pg::oid::float4, qb::pg::oid::float8, qb::pg::oid::boolean, qb::pg::oid::bytea,
 *               qb::pg::oid::date, qb::pg::oid::bpchar, qb::pg::detail::numeric,
 *               qb::io::async::run_until, qb::io::async::task<void>
 * @prerequisites 06-modules/pgsql/02-parameters
 * @expect "Successfully connected to PostgreSQL."
 * @expect "Data types example completed."
