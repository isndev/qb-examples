/**
 * @file examples/05-services/01-tcp-chat/server/ServerActor.cpp
 ...
 */
void
ServerActor::handleAuth(qb::uuid session_id, const std::string &username) {
 ...
 */
void
ServerActor::handleChat(qb::uuid session_id, const std::string &message) {
