/**
 * @file examples/05-services/02-pubsub-broker/server/ServerActor.h
...
public:
     ...
     */
    void handlePublish(qb::uuid session_id, broker::MessageContainer &&container, std::string_view topic, std::string_view content);
