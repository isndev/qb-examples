/**
 * @file examples/05-services/02-pubsub-broker/server/TopicManagerActor.h
...
private:
     ...
     */
    void sendToSession(qb::uuid session_id, qb::ActorId server_id, broker::MessageType type, const std::string &payload);
     ...
     */
    void sendToSession(qb::uuid session_id, qb::ActorId server_id, const broker::MessageContainer &shared_message);
