/**
 * @file examples/05-services/02-pubsub-broker/server/ServerActor.cpp
 ...
 */
void
ServerActor::on(NewSessionEvent &evt) {
 ...
 */
void
ServerActor::handleSubscribe(qb::uuid session_id, broker::Message &&msg) {
    ...
    qb::io::cout() << "Forwarding subscription request for topic: " << evt.topic << " from session: " << session_id << std::endl;
}
 ...
 */
void
ServerActor::handleUnsubscribe(qb::uuid session_id, broker::Message &&msg) {
    ...
    qb::io::cout() << "Forwarding unsubscription request for topic: " << evt.topic << " from session: " << session_id << std::endl;
}
 ...
 */
void
ServerActor::handlePublish(qb::uuid session_id, broker::MessageContainer &&container, std::string_view topic, std::string_view content) {
    ...
    qb::io::cout() << "Forwarding publish request to topic: " << evt.topic << " from session: " << session_id << std::endl;
}
 ...
 */
void
ServerActor::handleDisconnect(qb::uuid session_id) {
 ...
 */
void
ServerActor::on(SendMessageEvent &evt) {
