/**
 * @file examples/05-services/02-pubsub-broker/shared/Events.h
...
struct PublishEvent : public qb::Event {
     ...
     */
    PublishEvent(qb::uuid id, broker::MessageContainer &&container, std::string_view t, std::string_view c)
        : session_id(id)
