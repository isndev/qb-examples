/**
 * @file examples/01-actors/02-messaging.cpp
 * @tier 01-actors
 * @teaches Request and response between actors: who sent it, how the answer gets back, and why
 *          the pause in the middle is a coroutine sleep and never a blocked handler.
 * @demonstrates registerEvent<E>, push<E>, getSource(), spawn, qb::ScopedCoroContext, ctx.sleep,
 *               kill(), qb::Main, addActor<T>, qb::io::async::task<bool>
 * @prerequisites 01-actors/01-hello-actor
 * @expect "Main: Starting QB engine"
 * @expect ": Received all responses, terminating"
